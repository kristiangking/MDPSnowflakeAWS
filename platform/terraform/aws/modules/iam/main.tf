...
# ── Secrets Manager — dbt service account credentials ──────────
# NOTE: The Snowflake S3 IAM role (for storage integration) lives in the
# data product AWS Terraform, not here. It needs the raw bucket ARN which
# only the data product knows.
